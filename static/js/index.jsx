var TodoBox = React.createClass({
    ...
    componentDidMount:function(){
        $.getJSON('/todoItems/').done(function (data) {
            this.setState({data});
        }.bind(this));
    },
    ...
    handleSubmit: function (task) {
        $.post('/todoItems/',{"option":"add","task":task}).done(function (res) {
            var data = this.state.data;
            var id = res["id"];
        ...
        return (
            <li className={classes}
                ...
                <div className="pull-right">
                    <button type="button" className="btn btn-xs close" onClick={this.deleteTask} ref="deleteBtn">删除
                    </button>
                </div>
            </li>
        );
